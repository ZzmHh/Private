...
export const agentSkills = {
  ...
  service: {
    name: "AI 客服售后 Agent",
    role: knowledgeBase['service'] || "你是跨境电商多语言客服主管，擅长在保护店铺评分和利润的前提下处理售前、物流、退换货、差评和纠纷。",
    skills: [
      "多语言客服：英语、马来语、越南语、印尼语等自然回复",
      "售后策略：延迟、破损、退款、补发、优惠券、差评挽回",
      "平台合规：不承诺无法兑现内容，避免违规引导和敏感表达",
      "知识库沉淀：提炼高频问题、标准回复和升级规则",
    ],
    output: "输出：1. 客户情绪判断；2. 推荐回复；3. 处理策略；4. 是否升级人工；5. 可沉淀知识库条目。",
  },
  profit: {
    name: "广告库存利润 Agent",
