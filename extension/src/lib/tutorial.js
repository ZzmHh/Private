...
const FanmengTutorial = {
  ...
  sections: [
    ...
    {
      id: "cs_tier",
      title: "智能分层客服（FAQ / 夜间 / 售后）",
      steps: [
        "在草稿区写好常用回复 →「存为模板」，可填触发关键词（如：价格,多少钱,shipping）。",
        "简单售前：FAQ 命中后会自动填入并尝试点击发送。",
        "售后/退款：发安抚模板并尝试自动发送，同时在面板提示「售后待处理」需人工跟进。",
        "北京时间 23:00–09:00：FAQ 未命中时，非售后问题可由 AI 自动回复并发送。",
        "插件需在卖家中心浏览器保持打开；无人值守 Webhook 为网站高级配置（需 Partner），非必需。",
      ],
    },
    {
      id: "cs",
      title: "客服话术：手动与选中文字",
      steps: [
        "选中买家文字 →「手动生成话术」/ 右键「凡梦生成回复」/ Ctrl+Shift+Y。",
        "若未自动识别消息，务必先选中买家原文再点手动生成。",
        "自动监听开启后，系统按 FAQ → 夜间 AI → 草稿 分层处理。",
      ],
  ...
  faq: [
    ...
    { q: "会自动帮我把消息发出去吗？", a: "FAQ 命中或夜间 AI/售后安抚模板会尝试自动发送；复杂问题白天多为草稿需你确认。售后不会 AI 乱承诺退款。" },
